...
// Helper for i2c_get_adapter
struct i2c_adapter *rust_helper_i2c_get_adapter(int bus_number)
{
    return i2c_get_adapter(bus_number);
}
...
EXPORT_SYMBOL_GPL(rust_helper_i2c_transfer);

// Helper for i2c_new_client_device
struct i2c_client *rust_helper_i2c_new_client_device(struct i2c_adapter *adapter, struct i2c_board_info *info)
{
...
EXPORT_SYMBOL_GPL(rust_helper_i2c_master_send);

// Helper for i2c_master_recv
int rust_helper_i2c_master_recv(struct i2c_client *client, char *buf, int count)
{
    return i2c_master_recv(client, buf, count);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_master_recv);

// Helper for i2c_add_driver
int rust_helper_i2c_add_driver(struct i2c_driver *driver)
{
    return i2c_add_driver(driver);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_add_driver);

// Helper for i2c_del_driver
...
// Helper for i2c_smbus_write_byte
int rust_helper_i2c_smbus_write_byte(struct i2c_client *client, int value)
{
    return i2c_smbus_write_byte(client, value);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_write_byte);

// Helper for i2c_smbus_read_byte
int rust_helper_i2c_smbus_read_byte(struct i2c_client *client)
{
    return i2c_smbus_read_byte(client);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_read_byte);

// Helper for i2c_smbus_write_byte_data
int rust_helper_i2c_smbus_write_byte_data(struct i2c_client *client, int command, int value)
{
    return i2c_smbus_write_byte_data(client, command, value);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_write_byte_data);

// Helper for i2c_smbus_read_byte_data
int rust_helper_i2c_smbus_read_byte_data(struct i2c_client *client, int command)
{
    return i2c_smbus_read_byte_data(client, command);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_read_byte_data);

// Helper for i2c_smbus_write_word_data
int rust_helper_i2c_smbus_write_word_data(struct i2c_client *client, int command, int value)
{
    return i2c_smbus_write_word_data(client, command, value);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_write_word_data);

// Helper for i2c_smbus_read_word_data
int rust_helper_i2c_smbus_read_word_data(struct i2c_client *client, int command)
{
    return i2c_smbus_read_word_data(client, command);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_read_word_data);

// Helper for i2c_smbus_write_block_data
int rust_helper_i2c_smbus_write_block_data(struct i2c_client *client, int command, int length, const char *values)
{
    return i2c_smbus_write_block_data(client, command, length, values);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_write_block_data);

// Helper for i2c_smbus_read_block_data
int rust_helper_i2c_smbus_read_block_data(struct i2c_client *client, int command, char *values)
{
